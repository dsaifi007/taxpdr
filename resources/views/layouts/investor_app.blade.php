...
<!-- start popup div ---->
	<div id="edit-proper-ty" class="modal fade" role="dialog">
    <div class="modal-dialog edit-proper-ty"  >
        <div class="modal-content">
            
           
                 <div id="show_edit_property" >
...
<div id="delete-proper-ty" class="modal fade" role="dialog">
    <div class="modal-dialog delete-proper-ty">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="popup_title_id" >Delete property</h4>
            </div>
            <div class="modal-body text-center">
                <p id="message_id">Are you sure you want to delete this property?</p>
...
/*Multi checkbox by Om 22.03.2018*/
