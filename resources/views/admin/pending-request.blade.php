        ...
        <div class="content">
            ...
            <div class="row animated fadeInUp">
                <div class="manage-schools manage-user">
                    <div class="col-sm-12">
                        <h4 class="section-subtitle"><b>Manage Pending Requests</b></h4>
                                ...
                                <div class="table-responsive">
                                    <div class="dataTables_wrapper">
                                        <div class="row">
                                           ...
                                           <li class="active"><a href="{{route('admin.pending.requests')}}">Pending Request</a></li>
                                    ...
                                    <table class="table table-striped table-hover table-bordered text-center" id="investor-table">
                                        ...
                                        <tr>
                                            ...
                                            <td ><select name="valuer_id" id="valuer_id{{ $single_requests->id }}" style="width: 80%"; class="assigned" ><option value="0">
                                             Assign </option>
...
@endsection
@section('java-script')
<script src="{{ asset('admin/javascripts/chosen.jquery.min.js') }}"></script>
