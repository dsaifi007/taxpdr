                                ...
                                <nav class="main-menu">
                                    ...
                                    <div class="navbar-collapse collapse scroll-nav clearfix">
                                        <ul class="navigation clearfix">
                                           <li class="" id="valuer_home_li"><a href="{{ route('valuer-dashboard') }}">My Jobs</a></li>
                                        <li class="" id="valuer_job_history_li"><a href="{{ route('valuer.job.history')}}">Job History</a></li>
                                        <li class="dropdown" id="profile_id"><a href="{{route('myprofile')}}" class="ellipsis">{{ substr(\Auth::user()->name,0,20)}}</a>
                                            <ul>
                                                ...
                                                <li><a href="{{ route('change.password') }}"><i class="fa fa-cog" aria-hidden="true"></i> Change Password</a></li>
                                                 <li><a href="{{ url('/logout') }}"><i class="fa fa-sign-out" aria-hidden="true"></i> Log Out</a></li></li>
                                            </ul>
                                        </li>
