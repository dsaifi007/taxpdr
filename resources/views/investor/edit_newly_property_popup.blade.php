 ...
 <button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<div class="modal-body">
				<div class="card-content prop-edit-2">
					...
					<div class="divider">
					 ...
					 <form id="editform" name="lform" method="POST" action="{{ route('investor.saverequest') }}" onsubmit="return editproperty()">
													{{ csrf_field() }}
					<div class="form-group">
															...
															<div class="col-md-6 col-sm-12">
																 <div class="form-group">
																		<label>Year of Purchase </label>
																		 <select class="form-contro" id="purchase_year" name="purchase_year[]"  onchange="return editproperty();">
																				<?php
																...
																<div class="form-group">
																	<div class="form-group">
																		...
																		<div class="icon-doller">
																			<input type="number"  name="purchase_price[]" value="{{ $saved_address->purchase_price }}" class="form-contro numberallow" required data-required-message="{!! trans('messages.reqired_field') !!}"  data-parsley-type="number" data-type-message="{!! trans('messages.valid_price') !!}" min="100000" data-parsley-min="100000" data-parsley-min-message="{!! trans('messages.min_property_price') !!}">
					...
					@foreach($property_types as $property_type)
						<label class="radio-inline">
							<input type="radio" required data-required-message="{!! trans('messages.reqired_field') !!}" @if($saved_address->property_type == $property_type->id) checked @endif value="{{ $property_type->id }}" name="property_type0" id="property_type{{ $property_type->id }}" />{{ ucfirst($property_type->name) }}
						</label>
					@endforeach
					</div>
															</div>
																	...
																	<div class="row"> 
																		<div class="col-md-12">
																			...
																			<label style="display: block;">Was the property purchased new?</label>
																				<label class="radio-inline"><input @if($saved_address->property_new_status != 'no') checked @endif  name="property_new_status0" value="yes" type="radio" checked="checked">Yes</label>
																				<label class="radio-inline"><input @if($saved_address->property_new_status == 'no') checked @endif   
																				 name="property_new_status0" value="no" type="radio" />No</label>
																			</div>        
																		</div>
																</div>
															</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12"> 
							<div class="form-group">
								<input type="checkbox" class="filled-in form-check-input" checked="checked" name="saved_address0" id="checkbox0" value="1">&nbsp; Update in saved property
					...
					<div class="tow-btn text-center">
						<input type="hidden" name="id" value="{{ $saved_address->cart_id }}" />
