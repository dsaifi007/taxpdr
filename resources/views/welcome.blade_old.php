                    ...
                    <div class="content-column">
                        <div class="clearfix">
                            <div class="content-box">
                                ...
                                <div class="sec-title">
                                    <h2>As a <span style="color:#1A9BD7;">Property Agents</span></h2>
                                </div>
                                <div class="text-content">
                                    <p>Request investment property depreciation report on behalf of their clients.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-column">
                        <div class="clearfix">
                            <div class="content-box">
                                ...
                                <div class="sec-title">
                                    <h2>As an <span style="color:#1A9BD7;">Accountants</span></h2>
                                </div>
                                <div class="text-content">
